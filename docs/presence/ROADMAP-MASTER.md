...
### Presence CMS Phase 1 — Hardening track (M1–M10) — IN PROGRESS: 6 of 10 implemented (60%) · M4 idempotency awaiting owner migration activation
...
- ⏳ **M7 (NEXT active) → M10** — remaining in the approved order: M7 snapshot retention GC · M8 preview hardening · M9 client UX safety · M10 ops/load/DR. Not reordered.
