...
### Presence CMS Phase 1 — Hardening track (M1–M10) — IN PROGRESS: 9 of 10 implemented (90%) · M4 FULLY LIVE (mig 0073 applied both envs)
...
- ⏳ **M10 (NEXT active, FINAL)** — Ops: load test + DR drill. Owner-gated: PITR on prod before the DR drill + a staging load environment; the load test tunes M5's deploy-ceiling constant. Not reordered.
