...
### Presence CMS Phase 1 — Hardening track (M1–M10) — IN PROGRESS: 7 of 10 implemented (70%) · M4 idempotency awaiting owner migration activation
...
- ⏳ **M8 (NEXT active) → M10** — remaining in the approved order: M8 preview hardening · M9 client UX safety · M10 ops/load/DR. Not reordered.
