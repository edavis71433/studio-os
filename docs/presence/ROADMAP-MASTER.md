...
### Presence CMS Phase 1 — Hardening track (M1–M10) — IN PROGRESS: 5 of 10 implemented (50%) · M4 idempotency awaiting owner migration activation
...
- ⏳ **M6 (NEXT active) → M10** — remaining in the approved order: M6 media hardening · M7 snapshot retention GC · M8 preview hardening · M9 client UX safety · M10 ops/load/DR. Not reordered.
