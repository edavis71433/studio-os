...
- ⏳ **P2-C — Sales & Customer Lifecycle** *(next active)* — leads · CRM · pipeline · proposals/quotes · contracts · convert→provisioned Client App · onboarding (multi-tenant, end-to-end).
