...
- ⏳ **P2-D — Projects, Communication & Service Delivery** *(NEXT ACTIVE — do not begin implementation without explicit approval)* — projects · tasks · milestones · files · messaging · notifications · surveys · approvals · support · reporting.
