...
### FD-R2 · ✅ IMPLEMENTED (Phase UX) — the workspace speaks the business's language (Menu/Products/Classes/Programs/Services; template-first then industry; also fixed the preview /menu/ page-word bug on business-classic sites)
