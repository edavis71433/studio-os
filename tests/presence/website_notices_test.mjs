...
ok('helper: returns true only on a fresh insert (no double-fire) + never throws', /return ins\.ok && Array\.isArray\(ins\.json\) && ins\.json\.length > 0/.test(notice) && /catch \(e\)/.test(notice));
