...
ok('leads UI: converted enquiry shows "in pipeline — view deal" deep link (opens the Client Record)', /l\.converted\?`<a class="reply" href="\/crm\.html\?deal=\$\{esc\(l\.deal_id\|\|''\)\}&tab=deal"/.test(leads));
